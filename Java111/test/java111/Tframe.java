...
public class Tframe extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "hazelnut", "pumpkin", "chocolate", "mocha", "milk" }));
    ...
    public void definePrice(String pprodut){
         if(product.equals("hazelnut")){
             setPrice(100d);
        }
         else if(product.equals("pumpkin")){
             setPrice(200d);
         }
         else if(product.equals("chocolate")){
             setPrice(150d);
         }
         else if(product.equals("mocha")){
             setPrice(300d);
         }
